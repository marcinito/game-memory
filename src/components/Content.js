...
import { deleteStyleFromAddExampleImage } from "../Funkcje/PreventRepeatCode/DeleteStyleFromAddExampleImage";
import { transitionFromLevelToLevel } from "./TransitionFromLevelToLevel";
...
gameArea.appendChild(transitionFromLevelToLevel())
      //This timeout make a gap beetwen switch to next level//
        setTimeout(()=>{
          ...
          addExampleImage.forEach((el,i,arr)=>{
            ...
            btnAddImage.addEventListener("click",()=>{
               //Check if you are try add existing image in your level , to prevent add more than one the same image//
                ...
                deleteStyleFromAddExampleImage(addExampleImage)
